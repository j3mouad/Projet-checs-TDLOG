try :
    ...
    raise SystemExit(f"Error importing modules: {e}. Make sure all required libraries are installed.")

pygame.init()
if not pygame.get_init():
    raise SystemExit("Pygame failed to initialize. Please check your installation.")
